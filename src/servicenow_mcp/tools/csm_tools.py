...
Provides tools for querying standard CSM business entities: accounts, locations,
...
async def get_cases_by_product(
    ...
    """Get cases involving a product type.
...
async def get_cases_by_integration(
    ...
    Future: swap to a tenant-specific reference field on
    ``sn_customerservice_case``.
    """
    query_parts = [
